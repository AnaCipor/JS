...
console.log(peter); // peter parker
console.log(person); // john doe

// console.log(peter.fullName());  ERROR

peter.fullName = function () {
  return `${this.firstName.toUpperCase()} ${this.lastName.toLowerCase()}`; // PETER parker
};
...
/*
k          → название свойства
peter[k]   → значение свойства
typeof     → узнать тип значения
=== 'function' → проверить, функция ли это
peter[k]() → если функция, запустить её
*/
